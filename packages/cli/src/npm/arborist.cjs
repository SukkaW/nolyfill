/**
 * Parse package-lock.json w/ npm's arborist library.
 *
 * The file comes from https://github.com/npm/cli/blob/latest/workspaces/arborist/lib/arborist/index.js w/ minimum modifications:
 *
 * - Reduce unused mixins
...
const mixins = [
  ...
  // require('@npmcli/arborist/lib/arborist/build-ideal-tree.js'),
  ...
  // require('@npmcli/arborist/lib/arborist/reify.js'),
